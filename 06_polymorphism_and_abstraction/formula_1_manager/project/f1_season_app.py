...
class F1SeasonApp:
    ...
    def new_race_results(self, race_name: str, red_bull_pos: int,
        ...
        message_red_bull = self.red_bull_team.calculate_revenue_after_race(
            red_bull_pos)
        message_mercedes = self.mercedes_team.calculate_revenue_after_race(
            mercedes_pos)
        
        result = f"Red Bull: {message_red_bull}. Mercedes: {message_mercedes}. "
