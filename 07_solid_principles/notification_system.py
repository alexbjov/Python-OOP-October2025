...
class NotificationService:
    ...
    def notify(self, message: str):
        if self.sender.is_under_maintenance:
            print('This service is under maintenance.')
        else:
...
"""
The status change represents manual toggling done by an admin or a developer when they know a system component is
under maintenance.
